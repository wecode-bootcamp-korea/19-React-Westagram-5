...
class Logo extends Component {
  goToMain = () => {
    fetch("http://10.58.4.98:8000/user/signup", {
      method: "POST",
      body: JSON.stringify({
        name: "iiii",
        email: "syeiongiI@naver.com",
        password: "12345",
      }),
    })
  ...
  inputAction = () => {
    ...
    inputIdLength > 0 && inputPwLength > 0
      ...
      <div className="colorBox">
        ...
        <div className="colorBox2">
          ...
          <input
            ...
            placeholder="비밀번호"
          />
          <button className="login" type="button" onClick={this.goToMain}>
            로그인
          </button>
          ...
          <button className="faceBook">
            ...
            <a className="face" href="https://www.facebook.com/login">
              Facebook으로 로그인
            </a>
          </button>
          <a
