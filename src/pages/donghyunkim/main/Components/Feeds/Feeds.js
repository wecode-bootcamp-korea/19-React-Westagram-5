...
class Feeds extends Component {
    ...
    componentDidMount() {
        ...
        fetch("http://localhost:3000/data/feedMob.json", {
            method: "GET",
        })
            .then((res) => res.json())
            .then((feedData) => {
    ...
    commentUp = (e) => {
        ...
        if (this.state.comment.length < 0) {
            ...
            commentArr.push({
                id: this.state.commentArr.length + 1,
            ...
            <>
                <main>
                    <div id="feeds">
                            ...
                            <ul>
                                <li>
                                    <button>
                                        <img
                                            alt="더 피커"
                                            src="https://scontent-ssn1-1.cdninstagram.com/v/t51.2885-19/s150x150/26869616_2317743801831782_9081632034413084672_n.jpg?tp=1&_nc_ht=scontent-ssn1-1.cdninstagram.com&_nc_ohc=tupDzr9HTDgAX_1bCEC&ccb=7-4&oh=1c248fbfa62e0e36910e53522de65ec5&oe=60866584&_nc_sid=7bff83"
                                        />
                                        <div></div>
                                        <span>picker</span>
                                    </button>
                                ...
                                <li>
                                    <button>
                                        ...
                                        <img
                                            alt="한살림"
                                            src="https://scontent-ssn1-1.cdninstagram.com/v/t51.2885-19/s150x150/61803512_2281741025476680_2611456685675380736_n.jpg?tp=1&_nc_ht=scontent-ssn1-1.cdninstagram.com&_nc_ohc=PADUnRC1KS0AX9nGiep&ccb=7-4&oh=0d62ffcff9dfa1d6f47be789bd6360e2&oe=60876D92&_nc_sid=a9513d"
                                        />
                        ...
                        {feedArr.map((feedBox) => {
                            return (
                                <div id="feedBox" key={feedBox.id}>
                                    <div class="feedHeader">
                                        <div>
                                            <a>
                                                <img src={feedBox.imgUrl} />
                                            </a>
                                            <a>
                                                <span>{feedBox.feedId}</span>
                                            </a>
                                        </div>
                                        <button>
                                            <div></div>
                                    ...
                                    <img class="feedImg" src={feedBox.feedImg} />
                                    <div class="feedIcons">
                                    ...
                                    <div class="feedLikeCnt">
                                        <p>
                                            좋아요 <span>{feedBox.goodCnt}</span>개
                                        </p>
                                    </div>
                                    <div class="feedComment">
                                        <ul>
                                            <CommentList key={commentArr.id} commentArr={commentArr} />
                                        </ul>
                                    </div>
                                    <div class="feedTime">
                                        <a>
                                    ...
                                    <div class="commentUpBox">
                                        <form action="#" method="POST">
                                            ...
                                            <button
                                                className={
                                                    "commentUpButton " +
                                                    (buttonDisable ? "commentUploadFalse" : "commentUpload")
                                                }
                                                type="button"
