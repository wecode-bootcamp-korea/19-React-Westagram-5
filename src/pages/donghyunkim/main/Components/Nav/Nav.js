                ...
                <nav>
                    <div class="mainWidth">
                        ...
                        <div className="searchBar">
                            <input type="text" onClick={clickSearchBox} onBlur={inputBlur} onKeyUp={searchBoxKeyup} focus={valueIn} />
                            <div onClick={clickSearchBox} className={searchBarOn ? "searchBarOn" : "searchBarOff"}>
                                ...
                                />
                                <span onClick={clickSearchBox} className={valueIn ? "searchBarSpanValueIn" : "searchBarSpanValueOut"}>
                                    검색
                                </span>
                            </div>
                        </div>
                        <div id="navRightImgBox">
                            ...
                            />
                            <img alt="사람찾기" src="https://s3.ap-northeast-2.amazonaws.com/cdn.wecode.co.kr/bearu/explore.png" />
                            <img
                                alt="활동피드"
